...
module.exports = (Discord, client, message) => {
    ...
    if (message) {
        ...
        if (message.mentions.has(client.user.id) && message.content == '<@!795161660050505800>') {
            console.log(message.content);
            message.channel.send("Hello there!");
            m = `The Prefix of this Bot is [**${prefix}**]` + '\n'
                + `Type **${prefix}cmd** for the list of the commands and brief description`
    ...
    if (!(message.guild.id == '818503228076457984')) {
